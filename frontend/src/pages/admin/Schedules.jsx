        ...
        >
          <button
            ...
            style={{
              ...
              fontWeight: "600",
              cursor: "pointer",
              background: filterDay === "all" ? "#0a1628" : "#fff",
              color: filterDay === "all" ? "#fff" : "#64748b",
              boxShadow:
                filterDay === "all" ? "none" : "0 1px 2px rgba(0,0,0,0.05)",
            }}
          >
            All Days
          </button>
          {DAYS.map((day) => (
            <button
              ...
              style={{
                ...
                fontWeight: "600",
                cursor: "pointer",
                background: filterDay === day ? dayColors[day] : "#fff",
                color: filterDay === day ? dayTextColors[day] : "#64748b",
                boxShadow:
                  filterDay === day ? "none" : "0 1px 2px rgba(0,0,0,0.05)",
              }}
            >
              {day.slice(0, 3)}
            </button>
          ...
          {filtered.map((s) => (
            ...
            >
              ...
              >
                ...
                <span
                  style={{
                    background: dayColors[s.day_of_week] || "#f3f4f6",
                    color: dayTextColors[s.day_of_week] || "#374151",
                    fontSize: "11px",
                    fontWeight: "700",
                    padding: "3px 8px",
                    borderRadius: "6px",
